...
//        $data['']=$request->;
   ...
   public function edit_manufacture($id) {
        $category_info = DB::table('manufacture')
                ->where('id', $id)
                ->first();
        $edit_manufacture = view('admin.pages.edit_manufacture')
                ->with('category_info', $category_info);
        return view('admin.admin_master')->with('admin_content', $edit_manufacture);
    }
