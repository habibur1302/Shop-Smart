...
<!--                                    <ul>
                                        <li class="product-info">
                                            <div class="p-left">
                                                ...
                                                <a href="#">
                                                   <img class="img-responsive" src="{{URL::to('/show-cart')}}" alt="p10">
                                                </a>
                                            </div>
                                            <div class="p-right">
                                        ...
                                        <li class="product-info">
                                            <div class="p-left">
                                                <a href="#" class="remove_link"></a>
                                                <a href="#">
                                                    <img class="img-responsive" src="{{URL::to('public/frontend_assets/data/product-s5-100x122.jpg')}}" alt="p10">
                                                </a>
                                            </div>
                                            <div class="p-right">
                                                <p class="p-name">Donec Ac Tempus</p>
...
<!--                                <div class="toal-cart">
                                ...
                                <div class="cart-buttons">
                                    <a href="{{URL::to('/cart')}}" class="btn-check-out">View Cart</a>
