                  ...
                  <div class="navbar-brand"><a href="#"><img alt="fashion" src="{{URL::to('public/frontend_assets/data/fashion.png')}}" />{!! $c_info->category_name!!}</a></div>
                    ...
                    <div class="collapse navbar-collapse">           
                        <ul class="nav navbar-nav">
                            <li class="active"><a data-toggle="tab" href="#tab-{{$c_info->id}}">Best Seller</a></li>
                            ...
                            <li><a href="#{{$child_c_info->category_name}}-{{$child_c_info->id}}">{{$child_c_info->category_name}}</a></li>
                            @endforeach
            ...
            <div class="product-featured clearfix">
                <div class="banner-featured">
                    ...
                    <div class="banner-img">
                        <a href="#"><img alt="Featurered 1" src="{{URL::to('public/frontend_assets/data/f1.jpg')}}" /></a>
                    </div>
                </div>
                <div class="product-featured-content">
                    <div class="product-featured-list">
                        <div class="tab-container">
                             tab product 
                            <div class="tab-panel active" id="tab-r{{$c_info->id}}">
                                <ul class="product-list owl-carousel" data-dots="false" data-loop="true" data-nav = "true" data-margin = "0" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":4}}'>
                                    <li>
                                        <div class="left-block">
                                            <a href="{{URL::to('/product')}}">
                                                <img class="img-responsive" alt="product" src="{{URL::to('public/frontend_assets/data/01_blue-dress.jpg')}}" />
                                            </a>
                                        ...
                                        <div class="right-block">
                                            <h5 class="product-name"><a href="#">White Dress</a></h5>
                            ...
                            <div class="tab-panel" id="tab-5">
                                <ul class="product-list owl-carousel" data-dots="false" data-loop="true" data-nav = "true" data-margin = "0" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":4}}'>
                                    <li>
                                        <div class="left-block">
                                            <a href="{{URL::to('/product')}}">
                                                <img class="img-responsive" alt="product" src="{{URL::to('public/frontend_assets/data/04_nice-dress.jpg')}}" /></a>
                                            <div class="quick-view">
                                                <a title="Add to my wishlist" class="heart" href="#"></a>
                                                <a title="Add to compare" class="compare" href="#"></a>
                                                <a title="Quick view" class="search" href="#"></a>
                                    ...
                                    <li>
                                        <div class="left-block">
                                            <a href="#">
                                                <img class="img-responsive" alt="product" src="{{URL::to('public/frontend_assets/data/06_red-dress.jpg')}}" /></a>
                                            <div class="quick-view">
                                                <a title="Add to my wishlist" class="heart" href="#"></a>
                                                <a title="Add to compare" class="compare" href="#"></a>
                                                <a title="Quick view" class="search" href="#"></a>
