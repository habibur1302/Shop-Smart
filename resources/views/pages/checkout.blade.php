...
function makerequest(email_address,objID)
{
  serverPage='ajax-email-check/'+email_address;
	   ...
	   xmlhttp.onreadystatechange=function()
	   {
		  ...
		  {
		     document.getElementByld(objID).innerHTML=xmlhttp.responseText;
                     if(xmlhttp.responseText=='Alerdy Exists !')
                     {
                         document.getElementByld('c_button').disabled=true;
                     }   
		  }
	   };
...
<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="page-content checkout-page">
            <h3 class="checkout-sep">1. LOGIN/REGISTER</h3>
                    ...
                    <tbody>
                        <tr>
                            <td class="cart_product">
                                <a href="#"><img src="frontend_assets/data/product-100x122.jpg" alt="Product"></a>
                            </td>
